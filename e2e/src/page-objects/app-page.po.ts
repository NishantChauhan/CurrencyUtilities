...
export class CurrencyUtilitiesAppPage {
  ...
  clickOnHomeLink() {
    return element(by.css('app-root nav a:nth-child(1)')).click() as Promise<
      void
    >;
  }
  clickOnCurrencyConvertorLink() {
    return element(by.css('app-root nav a:nth-child(2)')).click() as Promise<
      void
    >;
  }
  clickOnHistoricalRatesLink() {
    return element(by.css('app-root nav a:nth-child(3)')).click() as Promise<
      void
    >;
  }
  clickOnRateAlertsLink() {
    return element(by.css('app-root nav a:nth-child(4)')).click() as Promise<
      void
    >;
  }
  clickOnAboutLink() {
    return element(by.css('app-root nav a:nth-child(5)')).click() as Promise<
      void
    >;
  }
