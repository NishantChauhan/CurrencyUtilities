...
import { exchangeReponse, mockSupportedCurrencies } from 'src/app/mock-response/mock-reponse'
...
describe('ConvertorCardComponent', () => {
  ...
  it('should convert ' + fixedSourceCurrency.currencySymbol + ' to ' + fixedTargetCurrency.currencySymbol, () => {
    ...
    expect(component.convertorForm.get('targetAmount').value).toBe(exchangeReponse.result.toFixed(10))
  })
