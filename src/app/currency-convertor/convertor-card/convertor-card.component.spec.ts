...
describe('ConvertorCardComponent', () => {
  ...
  it('should update convert button on target currency change', () => {
    const supportedCurencyUSDIndex = component.findIndexOfCurrency('USD', component.supportedCurrencies)

    component.convertorForm.patchValue({
      targetCurrency: component.supportedCurrencies[supportedCurencyUSDIndex].currencySymbol,
    })
    fixture.detectChanges()
  ...
  it('should update convert button on source currency change', () => {
    ...
    component.convertorForm.patchValue({
      sourceCurrency: component.supportedCurrencies[supportedCurencyUSDIndex].currencySymbol,
    })
    fixture.detectChanges()
    component.updateCurrency()
    const buttonText = component.convertorForm.get('convertButtonText').value
